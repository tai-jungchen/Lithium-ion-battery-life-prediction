...
Author: Alex
-----------------------------------------------------
This python program test the battery data using XGBoost
"""
...
def main():
    ...
    for epoch in range(EPOCH):
        ...
        # Best model fit #
        reg = xgb.XGBRegressor(learning_rate=lr, n_estimators=num_tree, max_depth=max_split + 1,
                               reg_lambda=lmb, gamma=gamma)
